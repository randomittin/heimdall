...
unset HMD_FEXEC_TEST_KEY ANTHROPIC_MODEL HEIMDALL_FALLBACK_ASSUME_REACHABLE ANTHROPIC_BASE_URL DATA_DIR CLIPROXYAPI_CONFIG_DIR HMD_HEADROOM_DISABLE 2>/dev/null
