...
[![Version](https://img.shields.io/badge/version-2.3.6-00d4ff?style=flat-square)](CHANGELOG.md)
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/7f5ec0dcebffd6da6e02260c2b0f1beb9b67bbc0/install.sh -o heimdall-install.sh \
...
Pinned to the `v2.3.6` tag **and** checked against the sha256 of that tag's `install.sh`. The `&&`
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/7f5ec0dcebffd6da6e02260c2b0f1beb9b67bbc0/install.sh | shasum -a 256
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.3.6/install.sh.minisig
