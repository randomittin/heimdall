...
[![Version](https://img.shields.io/badge/version-2.3.7-00d4ff?style=flat-square)](CHANGELOG.md)
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/aa7c2b8e3c8dda508b9e01f41cb6ca7c50fe0b1a/install.sh -o heimdall-install.sh \
...
Pinned to the `v2.3.7` tag **and** checked against the sha256 of that tag's `install.sh`. The `&&`
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/aa7c2b8e3c8dda508b9e01f41cb6ca7c50fe0b1a/install.sh | shasum -a 256
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.3.7/install.sh.minisig
