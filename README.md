...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/v2.0.2/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/v2.0.2/install.sh -o install.sh
