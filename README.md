...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/v2.0.0/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/v2.0.0/install.sh -o install.sh
