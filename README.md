...
[![Version](https://img.shields.io/badge/version-2.3.5-00d4ff?style=flat-square)](CHANGELOG.md)
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/4a84f67216edd495520f21f698ccec3162ac9aef/install.sh -o heimdall-install.sh \
...
Pinned to the `v2.3.5` tag **and** checked against the sha256 of that tag's `install.sh`. The `&&`
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/4a84f67216edd495520f21f698ccec3162ac9aef/install.sh | shasum -a 256
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.3.5/install.sh.minisig
