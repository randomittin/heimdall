...
[![Version](https://img.shields.io/badge/version-2.3.4-00d4ff?style=flat-square)](CHANGELOG.md)
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/68815b8e7b40bd43d196a8e83ed57c7e41bbe34d/install.sh -o heimdall-install.sh \
...
Pinned to the `v2.3.4` tag **and** checked against the sha256 of that tag's `install.sh`. The `&&`
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/68815b8e7b40bd43d196a8e83ed57c7e41bbe34d/install.sh | shasum -a 256
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.3.4/install.sh.minisig
