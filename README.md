...
[![Version](https://img.shields.io/badge/version-2.4.0-00d4ff?style=flat-square)](CHANGELOG.md)
...
Pinned to the `v2.4.0` tag **and** checked against the sha256 of that tag's `install.sh`. <!-- HEIMDALL:PIN:TAG --> The `&&`
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.4.0/install.sh.minisig
