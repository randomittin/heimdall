# triage-coord — COVERAGE

What the `triage-coord` differential gate covers, and what is deliberately out of scope. This
domain is the UNIFIED triage-coord oracle; TRACK A (team-triaging) contributes the triage
...
`bin/falsify triage-coord --assert-score 1.0` — golden passes (impl == reference over the seeded
