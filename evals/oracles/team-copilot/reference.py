#!/usr/bin/env python3
# reference.py — the INDEPENDENT reference fold for the team-copilot (team-triaging) differential
# oracle.
#
# INDEPENDENCE (differential integrity). This module imports NOTHING from bin/lib/* — every rule
# below is HAND-REPRODUCED from evals/oracles/team-copilot/INVARIANTS.md, so it shares no code
