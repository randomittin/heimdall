...
[![Version](https://img.shields.io/badge/version-2.3.3-00d4ff?style=flat-square)](CHANGELOG.md)
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/679ecdebc0ed973128fa52dca135ed6331ee2721/install.sh -o heimdall-install.sh \
...
Pinned to the `v2.3.3` tag **and** checked against the sha256 of that tag's `install.sh`. The `&&`
...
```bash
curl -fsSL https://raw.githubusercontent.com/randomittin/heimdall/679ecdebc0ed973128fa52dca135ed6331ee2721/install.sh | shasum -a 256
...
```bash
curl -fsSL -O https://github.com/randomittin/heimdall/releases/download/v2.3.3/install.sh.minisig
